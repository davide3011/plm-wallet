...
MSG_TERMS_OF_USE = (
"""1. This wallet is based on Electrum and is distributed under the MIT licence. The original Electrum software is developed by Electrum Technologies GmbH. This customized version is provided as is, and comes without warranty.
...
3. We do not provide private user support. All issue resolutions are public, and take place on Github or public forums. If someone posing as wallet support proposes to help you via a private channel, this person is most likely an imposter trying to steal your palladiums."""
)
